...
/**
 * Create a spritesheet with a given prefix filename. It will load both 
 * the .plist and .png files (e.g. filename = orcSkeleton, it will load 
 * orcSkeleton.plist and orcSkeleton.png). These are generated by an
 * application such as TexturePacker that generates property files 
 * that is Cocos2D compatible. 
 * 
